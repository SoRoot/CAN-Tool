                           ...
                           uint32_t        const bytes)
{
    ...
    /** Transmitter must be disabled to start with. */
    HW_SCI_UartTransmitterDisable(p_sci_reg);
                                 ...
                                 uart_cfg_t         const * const p_cfg)
{
    ...
    if (0U != p_ctrl->fifo_depth)
    {
        ...
        else
        {
            ...
            HW_SCI_RxTriggerNumberSet(p_sci_reg, (uint16_t) (p_ctrl->fifo_depth - 1U));
        }
        ...
        else
        {
            ...
            HW_SCI_TxTriggerNumberSet(p_sci_reg, (uint16_t) (p_ctrl->fifo_depth - 1U));
        }
#endif
    }
